...
function ShoppingList() {
  ...
  var ddo = {
    ...
    controllerAs: 'listDiredctiveController',
...
function ShoppingListController(ShoppingListFactory) {
  ...
  list.RemoveItem = function (indexItem) {
    ...
    this.LastRemoved = "Last removed item " + this.getItems[indexItem].name;
...
function ShoppingList_Service(maxItems) {
  ...
  service.addItem = function (itemName, itemQuantity) {
    ...
    )
    {
      ...
      throw new Error("Max items ("+ Items.length +") wad reached");
    }
